    ...
    <div className="intro">
      ...
      <div className="flex flex-col justify-between p-10 lg:flex-row text-center md:text-left items-center lg:p-16">
        <div>
          ...
          <h3 className="text-xl pt-5 lg:w-[30vw]">
            In case of complicated problems that you cannot find answers to, ask
            one of our many trained professionals
          </h3>
          <div className="text-xl font-bold flex flex-col lg:flex-row pt-10 gap-10">
            <button type="button"></button>
          </div>
      ...
      <div className="flex flex-col justify-between p-10 lg:flex-row text-center md:text-left items-center lg:p-16">
        <div>
          ...
          <h3 className="text-xl pt-5 lg:w-[30vw]">
            If out website has a bug, please do report it! Your feedback is much
            appreciated.
          </h3>
          <div className="text-xl font-bold flex flex-col lg:flex-row pt-10 gap-10">
            <button type="button"></button>
